...
class SpotifyAggregator(BaseMusicService):
        ...
        try:
            ...
            for item in results["items"]:
                ...
                albums.append({
                    ...
                    "coverArt": self._get_best_image(album["images"]) if album.get("images") else None,
        ...
        try:
            ...
            for playlist in results["items"]:
                playlists.append({
                    ...
                    "coverArt": self._get_best_image(playlist["images"]) if playlist.get("images") else None,
                    "service": "spotify"
                })
        ...
        try:
            ...
            for artist in results["artists"]["items"]:
                artists.append({
                    ...
                    "name": artist["name"],
                    "image": self._get_best_image(artist["images"]) if artist.get("images") else None,
                    "service": "spotify"
                })
    ...
    def _get_best_image(self, images: List[Dict[str, Any]]) -> Optional[str]:
